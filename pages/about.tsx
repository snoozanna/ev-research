...
<section className='mb-8'>
  ...
  <Link href="/create" className="w-full sm:w-1/2 md:w-1/3">
      <button
        type="button"
        className="bg-(--darkpink) text-white text-xl uppercase font-bold w-full p-2 shadow-[4px_6px_0px_rgba(0,0,0,0.15)] rotate-[-3deg] hover:rotate-0 hover:shadow-[2px_3px_0px_rgba(0,0,0,0.2)] transition-all duration-200 mb-4"
      >
        Record a reflection
      </button>
    </Link>
  ...
  <p className='mb-2'>Although this is an early prototype, we want it to grow into something which offers audience members a meaningful, opt-in journaling practice: a way to build a personal record of art experiences that accumulates over time, similar to platforms like Goodreads but for performance.</p>
    ...
    <p className='mb-2'>Performance Journal is part of <span className='text-(--teal)'>Emergent Value</span>, an Arts and Humanities Research Council funded research project developing audience-centred approaches to capturing and understanding experiences of performance and theatre. You can find out more about it <a href="https://gtr.ukri.org/projects?ref=AH%2FX006743%2F1" target='_blank' className='text-(--darkpink)'>here.</a></p>
</section>
